 ...
 */
const t = window,
  i = t.ShadowRoot && (void 0 === t.ShadyCSS || t.ShadyCSS.nativeShadow) && 'adoptedStyleSheets' in Document.prototype && 'replace' in CSSStyleSheet.prototype,
  s = Symbol(),
  e = new WeakMap();
class o {
  constructor(t, i, e) {
    if (((this._$cssResult$ = !0), e !== s)) throw Error('CSSResult is not constructable. Use `unsafeCSS` or `css` instead.');
...
class y extends HTMLElement {
  constructor() {
    super(), (this.o = new Map()), (this.isUpdatePending = !1), (this.hasUpdated = !1), (this.l = null), this.u();
  }
  ...
  createRenderRoot() {
    var t;
    const i = null !== (t = this.shadowRoot) && void 0 !== t ? t : this.attachShadow(this.constructor.shadowRootOptions);
  ...
  $(t, i, s = m) {
    ...
    if (void 0 !== o && !0 === s.reflect) {
      const n = (void 0 !== (null === (e = s.converter) || void 0 === e ? void 0 : e.toAttribute) ? s.converter : p).toAttribute(i, s.type);
      (this.l = t), null == n ? this.removeAttribute(o) : this.setAttribute(o, n), (this.l = null);
    }
  }
  _$AK(t, i) {
    var s;
  ...
  requestUpdate(t, i, s) {
    let e = !0;
    void 0 !== t &&
      (((s = s || this.constructor.getPropertyOptions(t)).hasChanged || f)(this[t], i)
        ? (this._$AL.has(t) || this._$AL.set(t, i), !0 === s.reflect && this.l !== t && (void 0 === this.C && (this.C = new Map()), this.C.set(t, s)))
        : (e = !1)),
...
(y[_] = !0),
  ...
  (null !== (a = u.reactiveElementVersions) && void 0 !== a ? a : (u.reactiveElementVersions = [])).push('1.6.3');
const g = window,
  w = g.trustedTypes,
  ...
  E = Array.isArray,
  M = (t) => E(t) || 'function' == typeof (null == t ? void 0 : t[Symbol.iterator]),
  U = '[ \t\n\f\r]',
  N = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  R = /-->/g,
  O = />/g,
...
const F = (t, i) => {
  ...
  for (let i = 0; i < s; i++) {
      ...
      (u = r.lastIndex),
        r === N
          ...
          ? '>' === l[0]
            ...
            : void 0 === l[1]
            ? (a = -2)
            : ((a = r.lastIndex - l[2].length), (h = l[1]), (r = void 0 === l[3] ? V : '"' === l[3] ? z : j))
          : r === z || r === j
          ? (r = V)
          : r === R || r === O
          ? (r = N)
    ...
    n += r === N ? s + P : a >= 0 ? (e.push(h), s.slice(0, a) + $ + s.slice(a) + C + c) : s + C + (-2 === a ? (e.push(void 0), i) : c);
  }
...
class G {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    const r = t.length - 1,
      h = this.parts,
      [l, a] = F(t, i);
    if (((this.el = G.createElement(l, s)), (W.currentNode = this.el.content), 2 === i)) {
      ...
      if (1 === e.nodeType) {
            ...
            if (i.endsWith($) || i.startsWith(C)) {
              ...
              if ((t.push(i), void 0 !== s)) {
                const t = e.getAttribute(s.toLowerCase() + $).split(C),
                  i = /([.?@])?(.*)/.exec(s);
                h.push({ type: 1, index: o, name: i[2], strings: t, ctor: '.' === i[1] ? tt : '?' === i[1] ? st : '@' === i[1] ? et : Y });
        ...
        if (L.test(e.tagName)) {
          ...
          if (i > 0) {
            ...
            for (let s = 0; s < i; s++) e.append(t[s], A()), W.nextNode(), h.push({ type: 2, index: ++o });
            e.append(t[i], A());
          }
        }
        ...
        if (e.data === T) h.push({ type: 2, index: o });
          ...
          let t = -1;
          for (; -1 !== (t = e.data.indexOf(C, t + 1)); ) h.push({ type: 7, index: o }), (t += C.length - 1);
        }
      o++;
    }
  }
...
function K(t, i, s = t, e) {
  var o, n, r, h;
  if (i === D) return i;
  let l = void 0 !== e ? (null === (o = s.A) || void 0 === o ? void 0 : o[e]) : s.k;
  ...
  return (
    (null == l ? void 0 : l.constructor) !== a &&
      ...
      void 0 !== e ? ((null !== (r = (h = s).A) && void 0 !== r ? r : (h.A = []))[e] = l) : (s.k = l)),
...
class Q {
  ...
  M(t) {
    ...
    const {
      ...
      o = (null !== (i = null == t ? void 0 : t.creationScope) && void 0 !== i ? i : x).importNode(s, !0);
    W.currentNode = o;
    let n = W.nextNode(),
      r = 0,
      h = 0,
...
class X {
  constructor(t, i, s, e) {
    ...
    (this.type = 2),
      ...
      (this._$AM = s),
      (this.options = e),
      (this.N = null === (o = null == e ? void 0 : e.isConnected) || void 0 === o || o);
  }
  get _$AU() {
    var t, i;
    return null !== (i = null === (t = this._$AM) || void 0 === t ? void 0 : t._$AU) && void 0 !== i ? i : this.N;
  }
  get parentNode() {
  ...
  R(t) {
    this._$AH !== q && k(this._$AH) ? (this._$AA.nextSibling.data = t) : this.V(x.createTextNode(t)), (this._$AH = t);
  }
  O(t) {
    var i;
    const { values: s, _$litType$: e } = t,
      o = 'number' == typeof e ? this._$AC(t) : (void 0 === e.el && (e.el = G.createElement(Z(e.h, e.h[0]), this.options)), e);
    if ((null === (i = this._$AH) || void 0 === i ? void 0 : i._$AD) === o) this._$AH.U(s);
    else {
  ...
  j(t) {
    ...
    let s,
      e = 0;
    for (const o of t) e === i.length ? i.push((s = new X(this.L(A()), this.L(A()), this, this.options))) : (s = i[e]), s._$AI(o), e++;
...
class Y {
  constructor(t, i, s, e, o) {
    (this.type = 1),
      ...
      (this._$AM = e),
      (this.options = o),
      s.length > 2 || '' !== s[0] || '' !== s[1] ? ((this._$AH = Array(s.length - 1).fill(new String())), (this.strings = s)) : (this._$AH = q);
  }
  get tagName() {
  ...
  _$AI(t, i = this, s, e) {
    ...
    let n = !1;
    if (void 0 === o) (t = K(this, t, i, 0)), (n = !k(t) || (t !== this._$AH && t !== D)), n && (this._$AH = t);
    else {
      const e = t;
      let r, h;
...
class st extends Y {
  ...
  I(t) {
    t && t !== q ? this.element.setAttribute(this.name, it) : this.element.removeAttribute(this.name);
  }
}
class et extends Y {
  constructor(t, i, s, e, o) {
  ...
  _$AI(t, i = this) {
    var s;
    if ((t = null !== (s = K(this, t, i, 0)) && void 0 !== s ? s : q) === D) return;
    const e = this._$AH,
      o = (t === q && e !== q) || t.capture !== e.capture || t.once !== e.once || t.passive !== e.passive,
      n = t !== q && (e === q || o);
...
const nt = { H: $, B: C, D: T, q: 1, J: F, W: Q, Z: M, F: K, G: X, K: Y, X: st, Y: et, tt, it: ot },
...
const ht = (t, i, s) => {
  ...
  if (void 0 === r) {
    ...
    n._$litPart$ = r = new X(i.insertBefore(A(), t), t, void 0, null != s ? s : {});
  }
  return r._$AI(t), r;
};
/**
...
class ct extends y {
  ...
  update(t) {
    const i = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), (this.st = ht(i, this.renderRoot, this.renderOptions));
  }
  connectedCallback() {
    var t;
...
(ct.finalized = !0), (ct._$litElement$ = !0), null === (lt = globalThis.litElementHydrateSupport) || void 0 === lt || lt.call(globalThis, { LitElement: ct });
