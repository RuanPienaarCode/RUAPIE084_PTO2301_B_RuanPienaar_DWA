...
export const handleSettingsOverlayToggle =
	() => {
		...
		settingsOverlay.toggleAttribute(
			'open'
		);
	};
...
export const handleSettingsSave =
	(event) => {
		 ...
		 * @type {Object}
		 * @property {string} dark - The dark color value for the light theme.
		 * @property {string} light - The light color value for the light theme.
		 */
		const day = {
			dark: '10, 10, 20',
			light:
		 ...
		 * @type {Object}
		 * @property {string} dark - The dark color value for the dark theme.
		 * @property {string} light - The light color value for the dark theme.
		 */
		const night = {
			dark: '255, 255, 255',
			light:
