...
if (
	...
	throw new Error(
		'Range must be an array with two numbers'
	);

/**
 * Event listener for the show more button.
 * Calls the handleShowMoreClick function when the button is clicked.
 *
 * @type {EventTarget}
 */
...
listCloseButton.addEventListener(
	'click',
	handlePreviewToggle
);
...
const settingsOverlayButton =
	document.querySelector(
		'[data-header-settings]'
	);
settingsOverlayButton.addEventListener(
	'click',
	handleSettingsOverlayToggle
);
...
searchOverlayCancelButton.addEventListener(
	'click',
	createSearchOverlay
);
